...
const productGroups: ProductGroup[] = [
    {
        name: 'product1',
        detail: `物体検出を高速かつ高精度に実現するディープラーニングベースのアルゴリズムである
        YOLO（You Only Look Once）を自分でアノテーションしたデータで転移学習をしました。
        labelImgというツールを使用してアノテーションをし、その後そのデータを使ってすでにある重みから
        Google-Colabを使用して、追加学習をしました。アノテーションの際画像の前処理が大事になってきたため
        OpenCVを用いて解像度の調節や、マスク処理などをしました。
        また、検証用のために複数枚の画像を検証するコードを自作しました。（検証結果の画像は著作権の問題で
        ここには載せていません。）
        この学習した重みは今、Archaiveという図面管理システムで
        ある図面内の部品を検知するために使用されています。
        `,
        date: '2024/08',
    ...
    {
        name: 'product2',
        detail: `StarUpで図面管理システムArchaiveの実装に携わりました。Arichaiveは図面を管理するデータベースで
        それに加えて、AIによる類似図面検索が可能です。主に私はバックエンド側として携わり、データベースへのCRUD操作、
        エンドポイントの作成、新機能の開発へのPM、フルスタックとして携わりました。`,
        date: '2024/09',
        title: 'Archaive',
        image: [
    ...
    {
        name: 'product3',
        detail: `研究の一環で変分オートエンコーダ（VAE）を作成しました。VAEとはニューラルネットワークを用いた
        教師無し学習の手法の一つです。データセットはMNISTを使いました。`,
        date: '2024/06',
        title: '変分オートエンコーダ',
        image: [
    ...
    {
        name: 'product4',
        detail: `このサイトです。ある程度技術力がついてきたと思ったので、少しでも自分のことを知ってもらえたらと思って作成しました。
        全てデザインからコーディングまで全て自分で作成しました。`,
        date: '2025/05',
        title: 'ポートフォリオ',
        image: [
    ...
    {
        name: 'product5',
        detail: `このポートフォリオで使用している技術です。Contactフォームからお問い合わせいただくと、
        私のスラックに転送されるようになっています。`,
        date: '2025/05',
        title: 'スラックへの通知',
        image: [
    ...
    {
        name: 'product6',
        detail: `モバイルアプリ向けの手書き漢字認識モデルの開発に携わりました。スマホ向けの軽量なディープラーニングモデル
        であるEfficientNetを利用して、漢字のストロークデータを解析して、
        画像のみから認識精度を向上させるために追加学習をしました。`,
        date: '2024/10',
        title: '手書き漢字認識のモデル開発',
        image: [
